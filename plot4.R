...
globalReactivePower <- as.numeric(subSetElectricityData$Global_reactive_power)
voltage <- as.numeric(subSetElectricityData$Voltage)
subMetering1 <- as.numeric(subSetElectricityData$Sub_metering_1)
subMetering2 <- as.numeric(subSetElectricityData$Sub_metering_2)
subMetering3 <- as.numeric(subSetElectricityData$Sub_metering_3)
